    ...
    <div class="container">
      ...
      <div class="w3ls_logo_products_left1">
        <ul class="phone_email">
          ...
          <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:support@victoriajunction.in"><?php echo $results1['web_email']; ?></a></li>
        </ul>
      </div>
  ...
  <div class="banner">
    ...
    <div class="w3l_banner_nav_right">
      <!-- login -->
          ...
          <h2 style="margin-top:30px; margin-bottom:30px; text-align:center;">Forgot your Password?</h2>
          <!---728x90--->
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="forgot_password.php" method="POST">

...
<!---728x90--->
			<div class="w3l_banner_nav_right_banner3_btm">
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					...
					<ol>
						<li>Fresh Meat</li>
						<li>Available only on Order</li>
						<li>Frozen conditions</li>
					</ol>
				</div>
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
					...
					<ol>
						<li>Variety chips</li>
						<li>Best chocolates</li>
						<li>Flavours and Refreshners</li>
					</ol>
				</div>
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
...
<!---728x90--->
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_veg">
				...
				<?php
include('connect/connection.php');
				$records = $connection->prepare('SELECT * FROM products WHERE prod_type="Frozen Food" ORDER BY rand() LIMIT 8');
				$records->execute();

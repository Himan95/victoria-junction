...
<!-- Mirrored from empreuslabs.com/demos/july-2016/07-07-2016/grocery_store/web/household.php  [XR&CO'2014], Thu, 04 May 2017 08:01:14 GMT -->
<head>
<title>Victoria Junction | Households </title>
<!-- for-mobile-apps -->
...
<!---728x90--->
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$records = $connection->prepare('SELECT * FROM products WHERE prod_type="Cleaning"');
					$records->execute();
...
<!---728x90--->
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$records = $connection->prepare('SELECT * FROM products WHERE prod_type="Utensils"');
					$records->execute();
					$results=$records->fetch(PDO::FETCH_ASSOC);
					do{
					echo '
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$records = $connection->prepare('SELECT * FROM products WHERE prod_type="Pet Food"');
					$records->execute();
					$results=$records->fetch(PDO::FETCH_ASSOC);
					do{
					echo '
...
<!-- Mirrored from empreuslabs.com/demos/july-2016/07-07-2016/grocery_store/web/household.php  [XR&CO'2014], Thu, 04 May 2017 08:01:23 GMT -->
</html>

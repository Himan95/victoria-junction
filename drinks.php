...
<!---728x90--->
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$records = $connection->prepare('SELECT * FROM products WHERE prod_type="Soft Drinks"');
					$records->execute();
...
<!---728x90--->
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$records = $connection->prepare('SELECT * FROM products WHERE prod_type="Juices"');
					$records->execute();
					$results=$records->fetch(PDO::FETCH_ASSOC);
					do{
					echo '
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$records = $connection->prepare('SELECT * FROM products WHERE prod_type="Energy Drinks"');
					$records->execute();
					$results=$records->fetch(PDO::FETCH_ASSOC);
					do{
					echo '

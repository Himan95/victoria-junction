...
$records = $connection->prepare('SELECT * FROM termsandconditions');
$records->execute();
...
<head>
	<title><?php echo $results1['web_name']; ?> | Terms & Conditions </title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
		<h3 style="margin-top:12px;">Terms & Conditions</h3>

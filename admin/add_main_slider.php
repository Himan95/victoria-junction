...
if(isset($_POST['add_image'])){
  ...
  $stmt1=$connection->prepare('INSERT INTO main_slider (image_src) VALUES (:image_src)');
  $stmt1->bindParam(':image_src',$final_image);
  $stmt1->execute();
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel tile fixed_height_450">
              ...
              <div class="x_content">
                <form id="demo-form2" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" action="update_slider_images.php" method="post">

...
if(isset($_POST['update_refunds'])){

      $stmt1=$connection->prepare('UPDATE refunds SET description=:description');
      $stmt1->bindParam(':description',$description);
      $stmt1->execute();

      echo "<script>alert('Refunds Page updated!');</script>";
}
      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <center><h2>Victoria Junction | Update Refunds Page  </h2></center>
            <div class="x_panel tile fixed_height_450">
              <div class="x_title">
                <h2>Update Refunds Page</h2>

                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" action="refunds.php" method="post">

                  <div class="form-group">
                      <label class="control-label col-md-3" >Change Refunds Content<span class="required">*</span>
                      </label>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                      ...
                      <button type="submit" name="update_refunds" class="btn btn-success">Update Refunds</button>
                    </div>
                  </div>

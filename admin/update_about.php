...
if(isset($_POST['update_about'])){
      ...
      $stmt1=$connection->prepare('UPDATE about SET description=:description, about_image=:about_image');
      $stmt1->bindParam(':description',$description);
      $stmt1->bindParam(':about_image',$final_image);
      $stmt1->execute();
      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <center><h2>Victoria Junction | Update About Page  </h2></center>
            <div class="x_panel tile fixed_height_450">
              ...
              <div class="x_content">
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" action="update_about.php" method="post">
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                      ...
                      <button type="submit" name="update_about" class="btn btn-success">Update</button>
                    </div>
                  </div>

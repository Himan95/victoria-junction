      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            echo "<table id='datatable-responsive' class='table table-striped table-bordered dt-responsive nowrap' align='left' border='1'  cellspacing='2' cellpadding='2'  width='550px;'>
            <tr style='background-color:#EDEDED;padding:5px'>

            <!--<td align='left'<i><b>Id</b></i></td>-->
            <td style='padding:5px' align='left'<i><b>Sl No. </b></i></td>
            <td style='padding:5px' align='left'<i><b>Emails </b></i></td>
            <td style='padding:5px' align='left'<i><b>Subscribed On </b></i></td>
            </tr>";
            echo "<br />";
            ...
            do{
              $newDate = date_format(date_create_from_format('Y-m-d', $results2['subscribed_at']), 'd-m-Y');

              echo "<tr><td style='padding:3px' align='left'>".(++$count)."</td>";
              echo "<td style='padding:3px' align='left'>".$results2['email']."</td>";
              echo "<td style='padding:3px' align='left'>".$newDate."</td></tr>";

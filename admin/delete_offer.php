...
$records1 = $connection->prepare('SELECT * FROM offers');
$records1->execute();
      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <center><h2>Victoria Junction | Delete Offer  </h2></center>
            <div class="x_panel tile fixed_height_450">
              ...
              <div class="x_content">
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="delete_offer.php" method="post">
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" >Select Offer<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <select name="offer_name" class="form-control col-md-7 col-xs-12">
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                      ...
                      <button type="submit" name="delete_offer" class="btn btn-success">Delete Offer</button>
                    </div>
                  </div>

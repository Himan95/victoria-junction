...
$records = $connection->prepare('SELECT * FROM category WHERE category_name=:category_name');
$records->bindParam(':category_name', $category_name);
$records->execute();
...
if(isset($_POST['add_category'])){
    ...
    if(($results['category_name'])!=true)
    {
      $stmt1=$connection->prepare('INSERT INTO category (category_name,category_desc)  VALUES (:category_name,:category_desc)');
      $stmt1->bindParam(':category_name',$category_name);
      $stmt1->bindParam(':category_desc',$category_desc);
      $stmt1->execute();
      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <center><h2>Victoria Junction | Add New Category  </h2></center>
            <div class="x_panel tile fixed_height_450">
              ...
              <div class="x_content">
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="add_category.php" method="post">

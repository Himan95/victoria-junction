...
if(isset($_POST['update_product'])){
  ...
  /* Write Code to check if product doesnt exist using product_id */
  {
    ...
    echo "<script>alert('Please Choose Product Category!');</script>";
      ...
      $stmt=$connection->prepare('UPDATE products SET prod_name=:prod_name, prod_type=:prod_type, prod_price=:prod_price,prod_desc=:prod_desc,prod_quantity=:prod_quantity WHERE prod_id=:prod_id');
              ...
              <div class="x_content">
                <form method="POST" action="update_product.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <input type="number" required="required" id="prod_price" autocomplete="off" name="prod_price" class="form-control col-md-7 col-xs-12">
                    </div>
                    <label class="control-label col-md-3">Product Quantity<span class="required">*</span>
                    </label>
                    <div class="col-md-3">
                      <input type="number" required="required" autocomplete="off" id="prod_quantity" name="prod_quantity" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>

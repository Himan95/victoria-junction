...
if(isset($_POST['update_contact'])){
  ...
  $records2 = $connection->prepare('UPDATE web_info SET web_contact=:web_contact');
  $records2->bindParam(':web_contact',$web_contact);
  $records2->execute();
      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <center><h2>Victoria Junction | Update Contact  </h2></center>

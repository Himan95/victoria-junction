      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <center><h2>Victoria Junction | Update Email  </h2></center>
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="update_my_email.php" method="post">
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="email" required="required" placeholder="eg: abc@xyz.com" autocomplete="off" name="web_email" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>

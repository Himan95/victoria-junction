...
if(isset($_POST['delete_category'])){
      ...
      $stmt1=$connection->prepare('DELETE FROM category WHERE category_name=:category_name');
      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <center><h2>Victoria Junction | Delete Category  </h2></center>
            <div class="x_panel tile fixed_height_450">
              ...
              <div class="x_content">
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="delete_category.php" method="post">

...
<body>
	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			<!-- services -->
			<h2 style="margin-top:12px;font-size:250%; text-align:center;">Services</h2>
			<div class="w3ls_service_grids">
				<div class="col-md-12 w3ls_service_grid_left">
					<p style="position: relative; top: -50px;text-align: justify"><?php echo  $results['description']; ?></p>
				</div>
	...
	<div class="services-bottom">
		<div class="container">
			<div class="col-md-3 about_counter_left">
				...
				<p style="color:black;" class="counter">12,457<?php //echo $orders; ?></p>
				<h3 style="color:black;">Orders</h3>
			</div>
			<div class="col-md-3 about_counter_left">
				<i class="glyphicon glyphicon-piggy-bank" aria-hidden="true"></i>
				<p style="color:black;" class="counter">12,443<?php //echo $complete; ?></p>
				<h3 style="color:black;">Completed</h3>
			</div>
			<div class="col-md-3 about_counter_left">
				<i class="glyphicon glyphicon-export" aria-hidden="true"></i>
				<p style="color:black;" class="counter">14<?php //echo $pending; ?></p>
				<h3 style="color:black;">Pending</h3>
			</div>
			<div class="col-md-3 about_counter_left">
				<i class="glyphicon glyphicon-bullhorn" aria-hidden="true"></i>
				<p style="color:black;" class="counter">25,112<?php //echo $customers; ?></p>
	...
	<div class="newsletter-top-serv-btm" style="text-align:center;">
		<div class="container">

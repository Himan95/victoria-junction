...
<head>
	<title><?php echo $results1['web_name']; ?> | Cookies </title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			<div class="w3l_banner_nav_right_banner35 w3l_banner_nav_right_banner10">
				<?php
	...
	<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
		<h3 style="margin-top:12px;">Cookies</h3>

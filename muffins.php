...
<head>
	<title><?php echo $results1['web_name']; ?> | Muffins</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			<div class="w3l_banner_nav_right_banner20 w3l_banner_nav_right_banner10">
				<?php
	...
	<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
		<h3 style="margin-top:10px;">Muffins</h3>

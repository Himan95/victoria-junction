...
<head>
	<title><?php echo $results1['web_name']; ?> | Combos</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
		<h3 style="margin-top:12px;">Combos</h3>
		<div style="margin-left:20px;margin-right:20px;" class="w3ls_w3l_banner_nav_right_grid1">
			<?php
			$count=0;
			$records = $connection->prepare('SELECT * FROM products WHERE prod_type="Combos" AND prod_quantity>0');
			$records->execute();

...
<head>
	<title><?php echo $results1['web_name']; ?> | Breads   </title>
	<!-- for-mobile-apps -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="Victoria Junction, Siliguri - Custom Breads   fro Every Occassion, Gluten, Dairy & Egg-Free Options Available
...
<body>
	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			<div class="w3l_banner_nav_right_banner25 w3l_banner_nav_right_banner10">
				<?php
	...
	<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
		<h3 style="margin-top:12px;">Breads</h3>
		<div style="margin-left:20px;margin-right:20px;" class="w3ls_w3l_banner_nav_right_grid1">
			...
			if(!$results['prod_name'])
			{
				...
				do{
					...
					echo '
					<div style="margin-bottom:10px;"  class="col-md-3 w3ls_w3l_banner_left">

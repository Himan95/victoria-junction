...
<!-- Mirrored from empreuslabs.com/demos/july-2016/07-07-2016/grocery_store/web/vegetables.php  [XR&CO'2014], Thu, 04 May 2017 08:01:24 GMT -->
<head>
	<title>Victoria Junction | Fruits & Vegetables </title>
	<!-- for-mobile-apps -->
				...
				<div class="banner">
					...
					<div class="w3l_banner_nav_right">
						...
						<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_veg">
							...
							<?php
include('connect/connection.php');
							$records = $connection->prepare('SELECT * FROM products WHERE prod_type="Food" ORDER BY rand() LIMIT 12');
							$records->execute();
		...
		<!-- Mirrored from empreuslabs.com/demos/july-2016/07-07-2016/grocery_store/web/vegetables.php  [XR&CO'2014], Thu, 04 May 2017 08:01:34 GMT -->
		</html>

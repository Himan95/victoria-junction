...
$records = $connection->prepare('SELECT * FROM products WHERE prod_type="Snacks" AND prod_quantity>0');
$records->execute();
...
<!-- Mirrored from empreuslabs.com/demos/july-2016/07-07-2016/grocery_store/web/bread.php  [XR&CO'2014], Thu, 04 May 2017 08:02:05 GMT -->
<head>
<title>Victoria Junction | Bread & Bakery </title>
<!-- for-mobile-apps -->
...
<!---728x90--->
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
				...
				$records = $connection->prepare('SELECT * FROM products WHERE prod_type="Bread & Bakery" ORDER BY rand() LIMIT 8');
				$records->execute();
				$results=$records->fetch(PDO::FETCH_ASSOC);
				do{
				echo '
...
<!-- Mirrored from empreuslabs.com/demos/july-2016/07-07-2016/grocery_store/web/bread.php  [XR&CO'2014], Thu, 04 May 2017 08:02:15 GMT -->
</html>
